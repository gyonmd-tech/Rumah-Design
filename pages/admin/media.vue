  ...
  <div class="space-y-8">
    ...
    <div class="flex flex-wrap items-end justify-between gap-5 border-b border-ink/12 pb-6">
      <div>
        ...
        <h1 class="mt-3 font-display text-4xl font-bold text-ink tracking-tight">Media Library</h1>
      </div>
    ...
    <div
      class="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed p-10 transition-all text-center cursor-pointer bg-white/60"
    ...
    >
      ...
      <p class="font-display font-bold text-ink text-base">
        Tarik & Lepas Gambar / Video ke sini untuk upload instan
      </p>
    ...
    <!-- Search Toolbar -->
    <div class="flex items-center justify-between gap-4 rounded-3xl bg-white/80 p-4 border border-ink/10 shadow-xs">
    ...
    <div v-else-if="!filteredMedia.length" class="p-12 text-center rounded-3xl bg-white/70 border border-ink/10 space-y-2">
      <p class="font-display text-xl font-bold text-ink">Belum ada file media.</p>
    ...
    <div v-else class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
      ...
      >
        ...
        <div class="relative aspect-[16/10] w-full bg-ink/5 overflow-hidden">
          ...
          <button
            type="button"
            class="absolute top-2.5 right-2.5 rounded-full bg-void/80 text-white px-2.5 py-1 text-[0.65rem] font-mono uppercase font-bold opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer hover:bg-signal"
            title="Hapus Media"
        ...
        <div class="p-3.5 space-y-2">
          ...
          <div class="flex items-center justify-between font-mono text-[0.68rem] text-mute">
